...
<!-- Hero Section -->
 <div class="hero" style="background-image: url('img/بلدية اعزاز.png'); background-size: cover; background-position: center; background-repeat: no-repeat; position: relative; height: 500px;">
    <div class="hero-section" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); background-color: rgba(255, 255, 255, 0.5); backdrop-filter: blur(5px); padding: 4rem; border-radius: 1rem; width: 80%; max-width: 800px; text-align: center;">
        ...
        <div class="row">
            <div class="col-md-4 mb-4">
                <div class="info-box" style=" transition: all 0.3s;">
                    ...
                    <button class="btn btn-primary mt-3" style="background:var(--mian_color) ; border: none; transition: all 0.3s;" onmouseover="this.style.backgroundColor='#052e36'" onmouseout="this.style.backgroundColor='var(--mian_color)' ">المزيد</button>
                </div>
            </div>
            <div class="col-md-4 mb-4">
                <div class="info-box" style=" transition: all 0.3s;">
...
<section>
   <center><a href="user/complaints.php"><button class="btn btn-primary btn-block w-50" style="background: var(--brown); border: none; transition: all 0.3s; padding: 15px 30px; font-size: 1.5rem; font-weight: bold; border-radius: 50px; box-shadow: 0 4px 15px rgba(0,0,0,0.2);" onmouseover="this.style.backgroundColor='#052e36'; this.style.transform='scale(1.05)'; this.style.boxShadow='0 6px 20px rgba(0,0,0,0.3)'" onmouseout="this.style.backgroundColor='var(--brown)'; this.style.transform='scale(1)'; this.style.boxShadow='0 4px 15px rgba(0,0,0,0.2)'">تقديم شكوى</button></a></center>
</section>
<br>
<br>
<br>
